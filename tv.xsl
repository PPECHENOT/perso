			...
			<xsl:when test="$StartTime &lt; $StartDisplayCode and $StopTime &gt; $StopDisplayCode">
				...
				<xsl:attribute name="colspan"><xsl:value-of select="(($Length - ($StopTime - $StopDisplayCode) - ($StartDisplayCode - $StartTime)))"/></xsl:attribute>
					...
					<xsl:attribute name="class">
						...
						<xsl:if test="$HighlightClickable and ($Categ='Acti' or $Categ='Horr' or $Categ='Guer' or $Categ='Espi' or $Categ='Anti' or $Categ='Poli' or $Categ='Anim' or $Categ='Cata' or $Categ='Hist' or $Categ='Aven' or $Categ='Scie' or $Categ='Fant' or $Categ='Pepl' or $Categ='Cine' or $Categ='Film' or $Categ='Dram' or $Categ='Comé' or $Categ='Mélo' or $Categ='West' or $Categ='Thri' or $Categ='Biog' and $OnClick='IMDB' or ($OnClick='URL' and url))">
							Clickable
						</xsl:if>
...
<div style="clear:both"></div>
			...
			<xsl:choose>
				<xsl:when test="$OnClick='IMDB' and ($Categ='Acti' or $Categ='Horr' or $Categ='Guer' or $Categ='Espi' or $Categ='Anti' or $Categ='Poli' or $Categ='Anim' or $Categ='Cata' or $Categ='Hist' or $Categ='Aven' or $Categ='Scie' or $Categ='Fant' or $Categ='Pepl' or $Categ='Cine' or $Categ='Film' or $Categ='Dram' or $Categ='Comé' or $Categ='Mélo' or $Categ='West' or $Categ='Thri' or $Categ='Biog')">
          <xsl:element name="a">
